...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-aLooisMB.mjs");
...
var manifest = {
	"68232eaaed01028ef324fcfed5aee9291d9ff0f16bed9d7b9172f1b90559a398": {
		functionName: "pullStation_createServerFn_handler",
		importer: () => import("./github.fn-Bk9oKro_.mjs")
	},
	"bc137a2bfc1be320ba421634b6768d801045a86ac96c6c44e9187849cbb7299c": {
		functionName: "pullWire_createServerFn_handler",
		importer: () => import("./wire.fn-BEHymTuG.mjs").then((n) => n.t)
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BiTPZ2ht.mjs").then((n) => n.t),
